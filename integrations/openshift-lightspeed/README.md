...
- **`litellm.yaml`** — Kubernetes deployment for LiteLLM proxy (auto-generated by Molty)
- **`ols-config.yaml`** — OpenShift Lightspeed configuration (auto-generated by Molty)
